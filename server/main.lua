...
AddEventHandler('esx_policejob:handcuff', function(target)
     ...
     if job == 'police' then
       TriggerClientEvent('esx_policejob:handcuff', target)
		...
		TriggerEvent("banCheater", source,"[esx_policejob] Attempted To Cuff: "..target)
      -- DropPlayer(_source,'[esx_policejob] Attempted To Cuff: '..target)
    end 
end)
...
AddEventHandler('esx_policejob:giveItem', function(itemName)
	...
	if xPlayer.job.name ~= 'police' then
		...
		return
	elseif (itemName ~= 'bulletproof' and itemName ~= 'clip') then
		print(('esx_policejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
		return
	end
...
AddEventHandler('esx_policejob:message', function(target, msg)
	...
	TriggerClientEvent('esx:showNotification', target, msg)
		...
		TriggerEvent("banCheater", source,"[esx_policejob] Fake Message: "..msg)
		-- DropPlayer(_source, '[esx_policejob] Fake Message: '..msg)
	end
end)